                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Expanded(child: DueDateWorkOrderDetailsScreenWidget()),
                          const SizedBox(width: 10),
                          Expanded(child: completeDateWorkOrderDetailsScreenWidget()),
                        ],
                      ),
                      const SizedBox(height: 10),
                            ...
                            child: Align(
                              ...
                              child: Transform.scale(
                                ...
                                child: CupertinoSwitch(
                                  ...
                                  value: true,//addWorkOrderScreenController.workOrderIsActive.value,
                                  onChanged: (value) {
                      ...
                      Align(
                        ...
                        child: SizedBox(
                            ...
                            child: ElevatedButton(
                                ...
                                onPressed: () async {
                                  // if (addWorkOrderScreenController
                                  //         .workOrderTypeValue.workOrderDetails ==
                                  //     AppMessage.selectWorkOrder) {
                                  //   CommonToastModule(
                                  //       msg: 'Select work order!',
                                  //       backgroundColor: AppColors.redColor);
                                  // } else {
                                  //   await addWorkOrderScreenController
                                  //       .addWorkOrderFunction();
                                  //   log('Add');
                                  // }
                                },
