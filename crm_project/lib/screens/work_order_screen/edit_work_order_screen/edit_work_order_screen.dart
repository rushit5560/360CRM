...
class EditWorkOrderScreen extends StatelessWidget {
 EditWorkOrderScreen({Key? key}) : super(key: key);
 final editWorkOrderScreenController = Get.put(EditWorkOrderScreenController());

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(titleText: 'Edit Work Order', leadingShow: false, actionShow: false),
      body: SafeArea(
