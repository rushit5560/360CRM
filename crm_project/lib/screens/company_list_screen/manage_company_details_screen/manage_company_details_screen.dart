                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            CommonTextFieldHeaderModule(
                                header: AppMessage.companyName, required: true),
                            const SizedBox(
                              height: 5,
                            ),
                            TextFieldModule(
                            ...
                            CommonTextFieldHeaderModule(
                                header: AppMessage.phone, required: false),
                            const SizedBox(
                              height: 5,
                            ),
                            TextFieldModule(
                            ...
                            CommonTextFieldHeaderModule(
                                header: 'Select company Type', required: true),
                            const SizedBox(
                              height: 5,
                            ),
