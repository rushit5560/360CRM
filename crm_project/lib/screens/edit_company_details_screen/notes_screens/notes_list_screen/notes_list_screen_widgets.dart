          ...
          child: Column(
            ...
            children: [
              Row(
               ...
               children: [
                 Expanded(
                   child: Text(notesListScreenController.notesList[i].notes,
                       maxLines: 1,
              ...
              Row(
                children: [
                  Expanded(
                    child: Text('${AppMessage.dateAdded}: ${DateFormatChanger().dateFormat(notesListScreenController.notesList[i].createdOn)}',
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
                        style: TextStyle(
                            fontWeight: FontWeight.bold,
                          ...
                          : Transform.scale(
                              ...
                              child: CupertinoSwitch(
                                ...
                                onChanged: (value) async {
                                  await notesListScreenController.changeNoteFunction(
                                    noteId: notesListScreenController.notesList[i].noteId.toString(),
                                    status: value,
                                    index: i,
                                  );
