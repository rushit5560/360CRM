...
class MtgAmortSchedule2ScreenWidget extends StatelessWidget {
  const MtgAmortSchedule2ScreenWidget({Key? key}) : super(key: key);
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('2500.00\$',style: TextStyle(color: AppColors.whiteColor1,fontWeight: FontWeight.bold,fontSize: 20.sp),)
              ],
            ).paddingAll(20),
            ),
          ),
                        ...
                        Expanded(flex: 8,
                          child: Column(crossAxisAlignment: CrossAxisAlignment.end,
                            children: [
                              ...
                              TextRow(title: 'Payment', subTitle: '27.06',suffix: '\$', subTitleColor: AppColors.grey700Color),
                              TextRow(title: 'Interest', subTitle: '27.06',suffix: '\$', subTitleColor: AppColors.grey700Color),
                              TextRow(title: 'Principal', subTitle: '',suffix: '\$', subTitleColor: AppColors.grey700Color),
                              TextRow(title: 'Balance', subTitle: '2500.00',suffix: '\$', subTitleColor: AppColors.grey700Color),
